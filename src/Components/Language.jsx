...
const Language = () => {
  ...
  return (
   <>
     <div className='' >
        <div className='flex bg-black border-[0.5px] rounded-[20px] px-2  py-[2px] w-[100px] md:w-[100px]'>
        <div className=" text-white bg-black text-center justify-center flex
                        md:" role="img" aria-hidden="true" >
            <svg className='w-[15px]' xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 16 16"  data-icon="LanguagesSmall" aria-hidden="true">
            ...
            <div>
              <select className='bg-black text-white text-[14px]'>
